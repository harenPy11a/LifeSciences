...
function News() {
  ...
  <section class="mb-32 md:text-left">
    ...
    <h2 class="mb-16 text-left ml-20 text-2xl">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</h2>


    <div class="mb-20 w-full p-4 text-center bg-gray-100 border border-gray-200 rounded-lg shadow sm:p-8">
    <h5 class="mb-2 text-3xl font-bold text-gray-900">Lorem ipsum dolor sit amet</h5>
    <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet.</p>
    <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
        <a href="#" class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            ...
            <div class="text-left">
                <div class="mb-1 text-xs">As seen on</div>
                <div class="-mt-1 font-sans text-sm font-semibold">temp1</div>
            </div>
        </a>
        <a href="#" class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            ...
            <div class="text-left">
                <div class="mb-1 text-xs">As seen on</div>
                <div class="-mt-1 font-sans text-sm font-semibold">temp2</div>
            </div>
        </a>
    </div>
</div>

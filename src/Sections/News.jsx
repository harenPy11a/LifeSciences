...
function News() {
  ...
  <section class="mb-32 md:text-left">
    ...
    <h2 class="mb-12 text-left ml-8 text-2xl">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat</h2>


    <div class="mb-20 w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Lorem ipsum dolor sit amet</h5>

...
function Testimonials() {
  return (
    <div className="pt-10">
      ...
      <div id="new" className="h-screen">
        <div class="overflow-hidden bg-white h-screen">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div class="flex h-auto">
                <div class="flex flex-col bg-black rounded-2xl">
                  ...
                  <div class="p-4 bg-gray-300 rounded-b-xl md:px-7d">
                    <div class="flex items-center">
                      <div class="flex-shrink-0">
                        <img
                          class="h-8 w-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem]"
              ...
              <div class="flex h-auto">
                <div class="flex flex-col bg-black rounded-2xl">
                  ...
                  <div class="p-4 bg-gray-300 rounded-b-xl md:px-7 ">
                    <div class="flex items-center">
                      <div class="flex-shrink-0">
                        <img
                          class="h-8 w-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem]"
